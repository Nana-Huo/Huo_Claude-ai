...
if (-not $VercelToken) {
    ...
    Write-Host "使用方法: .\deploy-to-vercel.ps1 -VercelToken "your-token" -ProjectId "your-project-id" [-TeamId "your-team-id"]" -ForegroundColor White
    exit 1
}
...
try {
    ...
    if ($_.Exception.Response) {
        $errorContent = Get-RemoteContent $_.Exception.Response
